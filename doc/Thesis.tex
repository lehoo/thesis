...
certain situations.  SimGrid is a generic simulation framework, which
can be used to simulate multiple kinds of distributed systems, such as
...
automatizing tests. SMPI validation is done by
...
was. Currently, this testing process consists of multiple different,
